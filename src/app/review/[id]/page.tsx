        ...
        >
          ...
          <div>
            ...
            <p className="text-xs" style={{ color: '#888' }}>
              Seller receives payment only after you approve
            </p>
          </div>
        </div>
        ...
        <div className="p-5 rounded-2xl glass-medium mb-6">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-3 p-3 rounded-xl" style={{ background: "rgba(15,15,15,0.3)" }}>
              <FileIcon />
              <span className="text-sm" style={{ color: "#888" }}>Files delivered by seller</span>
        ...
        >
          <div className="flex items-center justify-center gap-2 mb-1">
            ...
            <p className="text-sm" style={{ color: '#FFB800' }}>
              {daysLeft} {daysLeft === 1 ? 'day' : 'days'} left to review
            </p>
          </div>
          <p className="text-xs" style={{ color: '#888' }}>
            If you don't respond, payment will auto-release to seller
          </p>
        </div>
